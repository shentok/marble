...
find_path(QTMOBILITY_INCLUDE_DIR qmobilityglobal.h HINTS ${QT_INCLUDE_DIR} ${INCLUDE_INSTALL_DIR} PATH_SUFFIXES QtMobility)
...
foreach (index RANGE ${_component_count})
    ...
    if (NOT QtMobility_FIND_COMPONENTS OR QTMOBILITY_USE_${_COMPONENT})
        ...
        find_path(QTMOBILITY_${_COMPONENT}_INCLUDE_DIR ${file} HINTS ${QTMOBILITY_INCLUDE_DIR} ${QT_INCLUDE_DIR} PATH_SUFFIXES Qt${component})
