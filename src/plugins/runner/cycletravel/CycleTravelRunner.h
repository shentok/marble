...
#ifndef MARBLE_CYCLETRAVELRUNNER_H
#define MARBLE_CYCLETRAVELRUNNER_H
...
class CycleTravelRunner : public RoutingRunner
{
    Q_OBJECT

public:
    explicit CycleTravelRunner(QObject *parent = 0);
