...
#ifndef MARBLE_NAVIKI_ROUTINGRUNNER_H
#define MARBLE_NAVIKI_ROUTINGRUNNER_H
...
class NavikiRoutingRunner : public RoutingRunner
{
    Q_OBJECT

public:
    explicit NavikiRoutingRunner(QObject *parent = 0);
