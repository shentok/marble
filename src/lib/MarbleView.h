...
#ifndef MARBLE_MARBLEVIEW_H
#define MARBLE_MARBLEVIEW_H
...
class MarbleView : public QWidget
{
    Q_OBJECT
 ...
 public:
    ...
    /**
     * @brief Construct a new MarbleView.
     * @param map  the data map for the widget.
     * @param parent the parent widget
     */
    explicit MarbleView( MarbleMap *map, QWidget *parent = 0 );
