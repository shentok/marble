				 ...
				 GeoWriter& writer ) const
{
    ...
    writer.writeTextElement(kml::kmlTag_north, QString::number(latLonAltBox->north().toDegree()));
    writer.writeTextElement(kml::kmlTag_south, QString::number(latLonAltBox->south().toDegree()));
    writer.writeTextElement(kml::kmlTag_east,  QString::number(latLonAltBox->east().toDegree()));
    writer.writeTextElement(kml::kmlTag_west,  QString::number(latLonAltBox->west().toDegree()));
