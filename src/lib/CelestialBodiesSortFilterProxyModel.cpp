...
#include "CelestialBodiesSortFilterProxyModel.h"

namespace Marble
{

CelestialSortFilterProxyModel::CelestialSortFilterProxyModel( QObject *parent ) :
...
#include "CelestialBodiesSortFilterProxyModel.moc"
